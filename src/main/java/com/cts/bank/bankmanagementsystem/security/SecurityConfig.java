...
//         antMatchers(AUTH_WHITELIST).permitAll().
		httpSecurity.csrf().disable().httpBasic().and().authorizeRequests().antMatchers("/authenticate").permitAll()
				.antMatchers("/jer/createCustomer").permitAll().antMatchers("/swagger-ui.html").permitAll().antMatchers(AUTH_WHITELIST).permitAll().antMatchers(HttpMethod.OPTIONS, "/**").permitAll().anyRequest()
